                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="d-flex align-items-center">
                                            <img src="${cart.getProduct().getImageUrl()}" class="img-fluid me-5 rounded-circle" style="width: 80px; height: 80px;" alt="">
                                        </div>
                                    </th>
                                    <td>
                                    ...
                                    <td>
                                        <p class="mb-0 mt-4">${cart.getProduct().getPrice()} Triệu</p>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <p class="mb-0 mt-4">${cart.getProduct().getPrice() * cart.getQuantity()} Triệu</p>
                                    </td>
                                    <td>
                        ...
                        <div class="bg-light rounded">
                            ...
                            <div class="p-4">
                                ...
                                <div class="d-flex justify-content-between mb-4">
                                    ...
                                    <p class="mb-0">${totalAmount} Triệu</p>
                                </div>
                            </div>
                            <div class="py-4 mb-4 border-top border-bottom d-flex justify-content-between">
                                <h5 class="mb-0 ps-4 me-4">Total</h5>
                                <p class="mb-0 pe-4">${totalAmount} Triệu</p>
                            </div>
